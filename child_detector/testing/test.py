...
if __name__ == '__main__':
    ...
    df['location'] = df['cid'].apply(lambda x: cinf.loc[x, 'location']).apply(lambda x: x if x in test_locations else 'Soroka')
    ...
    plot_precision_recall(df_gender, 'gender', 'Gender', out_dir, t=None)
    plot_precision_recall(df_age, 'age_bin', 'Age', out_dir, t=None)
